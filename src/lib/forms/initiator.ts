...
export const initializeLogoutForm = async () =>
  await superValidate(zod(deleteAuthenticationSchema));
export const initializePostProjectForm = async () => await superValidate(zod(postProjectSchema));
export const initializeDeleteProjectForm = async () =>
  await superValidate(zod(deleteProjectSchema));
export const initializePostAssignmentForm = async () =>
  await superValidate(zod(postAssignmentSchema));
