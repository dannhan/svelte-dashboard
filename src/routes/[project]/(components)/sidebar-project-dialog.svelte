...
>
	...
	<Dialog.Content class="z-[60] w-screen border-none bg-card px-8 py-6">
		<form method="POST" action="/api/projects/" use:enhance class="space-y-4">
			...
			<div class="flex justify-end pt-10">
				<Button variant="ghost" class="hover:bg-muted" on:click={() => (open = false)}>
					Batalkan
				</Button>
				<Form.Button variant="ghost" class="text-secondary" bind:disabled>
					Tambah Proyek
				</Form.Button>
			</div>
		</form>
